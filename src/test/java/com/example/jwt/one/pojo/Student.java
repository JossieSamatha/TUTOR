 ...
 */
package com.example.jwt.one.pojo;
...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2220850145436510398L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"cn.tedu.pojo\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"gender\",\"type\":\"string\"},{\"name\":\"height\",\"type\":\"double\"},{\"name\":\"weight\",\"type\":\"double\"}]}");
  ...
  *//**
   ...
   *//*
  public Student(CharSequence name, Integer age, CharSequence gender, Double height, Double weight) {
    this.name = name;
    this.age = age;
    this.gender = gender;
    this.height = height;
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: height = (Double)value$; break;
    case 4: weight = (Double)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  *//**
   ...
   *//*
  public static cn.tedu.pojo.Student.Builder newBuilder() {
    return new cn.tedu.pojo.Student.Builder();
  }
  ...
  *//**
   ...
   * @return A new Student RecordBuilder
   *//*
  public static cn.tedu.pojo.Student.Builder newBuilder(cn.tedu.pojo.Student.Builder other) {
    return new cn.tedu.pojo.Student.Builder(other);
  }
  ...
  *//**
   ...
   * @return A new Student RecordBuilder
   *//*
  public static cn.tedu.pojo.Student.Builder newBuilder(cn.tedu.pojo.Student other) {
    return new cn.tedu.pojo.Student.Builder(other);
  }*/
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
    ...
    *//**
     ...
     * @param other The existing Builder to copy.
     *//*
    private Builder(cn.tedu.pojo.Student.Builder other) {
      super(other);
    ...
    *//**
     ...
     * @param other The existing instance to copy.
     *//*
    private Builder(cn.tedu.pojo.Student other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    *//**
      ...
      * @return This builder.
      *//*
    public cn.tedu.pojo.Student.Builder setName(CharSequence value) {
    ...
    *//**
      ...
      * @return This builder.
      *//*
    public cn.tedu.pojo.Student.Builder clearName() {
      name = null;
    ...
    *//**
      ...
      * @return This builder.
      *//*
    public cn.tedu.pojo.Student.Builder setAge(int value) {
    ...
    *//**
      ...
      * @return This builder.
      *//*
    public cn.tedu.pojo.Student.Builder clearAge() {
    ...
    *//**
      ...
      * @return This builder.
      *//*
    public cn.tedu.pojo.Student.Builder setGender(CharSequence value) {
    ...
    *//**
      ...
      * @return This builder.
      *//*
    public cn.tedu.pojo.Student.Builder clearGender() {
      gender = null;
    ...
    *//**
      ...
      * @return This builder.
      *//*
    public cn.tedu.pojo.Student.Builder setHeight(double value) {
    ...
    *//**
      ...
      * @return This builder.
      *//*
    public cn.tedu.pojo.Student.Builder clearHeight() {
    ...
    *//**
      ...
      * @return This builder.
      *//*
    public cn.tedu.pojo.Student.Builder setWeight(double value) {
    ...
    *//**
      ...
      * @return This builder.
      *//*
    public cn.tedu.pojo.Student.Builder clearWeight() {
    ...
    public Student build() {
      try {
        ...
        record.height = fieldSetFlags()[3] ? this.height : (Double) defaultValue(fields()[3]);
        record.weight = fieldSetFlags()[4] ? this.weight : (Double) defaultValue(fields()[4]);
        return record;
      } catch (Exception e) {
